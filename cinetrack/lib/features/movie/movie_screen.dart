                  ...
                  children: [
                    ...
                    Center(
                      child: LayoutBuilder(builder: (context, inner) {
                        final maxWidth = inner.maxWidth > 1100 ? 1000.0 : inner.maxWidth * 0.95;
                        return Container(
                          width: maxWidth,
                          ...
                          child: movies.when(
                            data: (movieList) {
                              ...
                              if (widget.movieId != null) {
                                movieSelected = movieList.firstWhere((m) => m.id == widget.movieId);
                              } else {
                                movieSelected = movieList.isNotEmpty ? movieList.first : null;
                              }
                              ...
                              return Column(
                                ...
                                children: [
                                        ...
                                        child: Card(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text('Título: ${movieSelected.titulo}', style: Theme.of(context).textTheme.titleMedium),
                                                const SizedBox(height: 8),
                                                Text('Gênero: ${movieSelected.generos}'),
                                                const SizedBox(height: 6),
                                                Text('Direção: ${movieSelected.direcao}'),
                                                const SizedBox(height: 6),
                                                Text('Ano: ${movieSelected.ano}'),
                                                const SizedBox(height: 12),
                                                Text('Sinopse:', style: Theme.of(context).textTheme.titleSmall),
                                                const SizedBox(height: 6),
                                                Text(movieSelected.sinopse, maxLines: 8, overflow: TextOverflow.ellipsis),
                                              ],
                                            ),
                                          ),
                                        ),
                                  ...
                                  const Text('Nenhuma avaliação por enquanto.', style: TextStyle(color: Colors.white70)),
                                ],
                              );
                            },
